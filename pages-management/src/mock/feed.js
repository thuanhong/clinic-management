...
export default [
  {
    ...
    avatar: <Avatar alt='Ali Connors' src={`${process.env.PUBLIC_URL}/static/images/face3.jpg`} />,
  ...
  },
  {
    ...
    avatar: <Avatar alt='Sandra Adams' src={`${process.env.PUBLIC_URL}/static/images/face4.jpg`} />,
