...
scp -r -i ~/clinic-rsa-key.pem ~/clinic-management/clinic ubuntu@52.204.105.231:/home/ubuntu/
...
ssh -i ~/clinic-rsa-key.pem ubuntu@52.204.105.231 "sudo docker-compose -f ~/clinic/docker-compose.deploy.yml up -d"
